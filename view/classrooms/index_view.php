        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a class="btn btn-warning" href="index.php?c=department&m=add"> Create new Class rooms</a>
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group my-3">
                                <input
                                    id="keywordDepartment"
                        ...
                        <tbody>
                            <?php foreach($departments as $key => $item): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm" href="index.php?c=department&m=edit&id=<?= $item['id'];?>"> Edit</a>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger btn-sm btn-outline-secondary" href="index.php?c=department&m=delete&id=<?= $item['id'];?>"> Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
