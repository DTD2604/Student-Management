                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <labe class="input-group-text" for="inputGroupFile02"> Logo </labe>
                                            <input type="file" class="form-control" id="inputGroupFile02" aria-describedby="inputGroupFileAddon04" aria-label="Upload" name="logo" />
